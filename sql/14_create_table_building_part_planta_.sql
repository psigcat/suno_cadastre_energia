...
UPDATE [SCHEMA_NAME].building_part_planta_[PLANTA] 
SET any_referencia = 0 
WHERE any_referencia IS NULL;
...
UPDATE [SCHEMA_NAME].building_part_planta_[PLANTA] AS c 
SET us_principal_nom = 
...
UPDATE [SCHEMA_NAME].building_part_planta_[PLANTA] 
SET area_planta_[PLANTA]_residencial = 0 
WHERE area_planta_[PLANTA]_residencial IS NULL;
...
UPDATE [SCHEMA_NAME].building_part_planta_[PLANTA] 
SET area_planta_[PLANTA]_terciari = 0 
WHERE area_planta_[PLANTA]_terciari IS NULL;
...
UPDATE [SCHEMA_NAME].building_part_planta_[PLANTA] 
SET area_planta_[PLANTA]_industrial = 0 
WHERE area_planta_[PLANTA]_industrial IS NULL;
...
UPDATE [SCHEMA_NAME].building_part_planta_[PLANTA] 
SET area_planta_[PLANTA]_exterior = 0 
WHERE area_planta_[PLANTA]_exterior IS NULL;
...
UPDATE [SCHEMA_NAME].building_part_planta_[PLANTA] 
SET area_planta_[PLANTA]_altres = 0 
WHERE area_planta_[PLANTA]_altres IS NULL;

-- Afegir número d'habitatges. Valor per defecte 0. Posteriorment només s'actualitzarà la pplanta 00
ALTER TABLE [SCHEMA_NAME].building_part_planta_[PLANTA] ADD COLUMN IF NOT EXISTS numberofdwellings int4 DEFAULT 0;
